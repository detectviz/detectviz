<!-- 此檔案用於 detectviz/detectviz repo 的 GitHub Profile README -->
...
- 50+ Grafana dashboards designed
- Billions of data points processed daily
- 80% performance improvement achieved
- Enterprise clients: TSMC, Cathay Financial, etc.
